...
public class FichaTableroBuilder{
    private FichaDominoTableroPanel fichaDominoTablero;
    private CasillaDTO casillaDTO;
    private FichaDominoDTO fichaDTO;

    public FichaDominoTableroPanel construirFicha(CasillaDTO casillaDTO) {
        this.casillaDTO = casillaDTO;
        this.fichaDTO = casillaDTO.getFichaDominoDTO();
        this.fichaDominoTablero = new FichaDominoTableroPanel();
