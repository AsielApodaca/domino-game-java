...
/**
 * Clase que gestiona las notificaciones de eventos relacionados con la
 * presentación de la partida de dominó. Permite la suscripción de un listener
 * que se encargará de procesar los eventos de selección de casilla y selección
 * de ficha, notificándolo a través de métodos específicos.
 *
 * <p>
...
public class PresentacionPartidaDominoNotificador implements IPresentacionPartidaDominoNotificador {
     ...
     * una clase en la capa de negocios.
     */
    private IPresentacionPartidaDominoListener presentacionPartidaDominoListener;

    /**
     * Suscribe un listener para recibir los eventos de presentación de la
     * partida de dominó.
     *
     * @param listener el listener que implementa la interfaz
     * {@link IPresentacionPartidaDominoListener}
     */
    @Override
    ...
    public void notificarPozoSeleccionado() {
        presentacionPartidaDominoListener.onPozoSeleccionado();
    }
