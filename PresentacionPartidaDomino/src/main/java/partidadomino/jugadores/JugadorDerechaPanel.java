...
public class JugadorDerechaPanel extends JugadorPanel {
    ...
    private static final int LOCACION_X_DESDE_DERECHA = 10;
    ...
    public JugadorDerechaPanel(JugadorDominoDTO jugadorDominoDTO) {
    ...
    protected void paintComponent(Graphics g) {
        // Pintar Sección 2 (anteriormente Sección 1, ahora a la izquierda)
        int x2 = 0;
        int y2 = 0;
        ...
        // Pintar Sección 1 (anteriormente Sección 2, ahora a la derecha)
        int x1 = x2 + ancho2;
        int y1 = 0;
        ...
        // Pintar Sección 3 (igual que en JugadorIzquierdaPanel)
        int x3 = 0;
        int y3 = altura1;
    ...
    protected void reescalarJugadorPanel() {
        ...
        if(contenedorPadre != null) {
            ...
            int locacionX = (int) (anchoPantalla - ancho - LOCACION_X_DESDE_DERECHA * escala);
