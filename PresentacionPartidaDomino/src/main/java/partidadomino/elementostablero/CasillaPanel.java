...
public class CasillaPanel extends JPanel{
    ...
    private static final Logger LOG = Logger.getLogger(CasillaPanel.class.getName());
    ...
    public void cargarFondo() {
        try {
            ...
            LOG.log(Level.SEVERE, "No se pudo cargar la imagen de fondo: " + fuenteImagenCasilla, ex);
        }
    }
