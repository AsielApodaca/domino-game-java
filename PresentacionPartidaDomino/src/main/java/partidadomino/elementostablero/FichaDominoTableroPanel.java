...
public class FichaDominoTableroPanel extends JPanel {

    private static final Logger LOGGER = Logger.getLogger(FichaDominoTableroPanel.class.getName());
    ...
    public FichaDominoTableroPanel() {
        setLayout(null);
        setOpaque(false);
        cargarFondo();
    }
