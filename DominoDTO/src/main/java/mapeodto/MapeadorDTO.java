...
/**
 * Clase encargada de mapear las entidades del dominio a sus respectivos Data
 * Transfer Objects (DTO). Este mapeador facilita la transferencia de datos
...
public class MapeadorDTO {
    ...
    public static UsuarioDTO UsuarioEntityADTO(UsuarioEntity usuarioEntity) {
        ...
        usuarioDTO.setFuenteIcono(usuarioEntity.getFuenteIcono());
     ...
     *
     * @param configuracionJuegoEntity La entidad de configuración de juego a
     * mapear.
     * @return Un objeto {@link ConfiguracionJuegoDTO} que representa la
